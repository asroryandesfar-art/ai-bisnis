...
VALUES
 ...
 ('business',   'Business',   999000,  9990000,  25000, 15, 30, 200, 8,
  '{"description": "Untuk perusahaan dengan banyak agent, tim, dan kebutuhan integrasi API.", "highlights": ["15 AI Agents", "25.000 percakapan/bulan", "API Access", "Priority Support", "Multi-tenant"], "branding_botnesia": false, "knowledge_base": true, "analytics": true, "analytics_advanced": true, "whatsapp": true, "multi_user": true, "api_access": true, "priority_support": true, "multi_tenant": true, "white_label": false, "custom_pricing": false}', 3),
 ('enterprise', 'Enterprise', 0,       0,        -1,    -1, -1, -1, -1,
  '{"description": "Solusi custom dengan SLA, white label, dan integrasi khusus untuk enterprise.", "highlights": ["Unlimited AI Agents", "Unlimited percakapan", "White Label", "Dedicated Support", "Custom Integration", "SLA perusahaan"], "branding_botnesia": false, "knowledge_base": true, "analytics": true, "analytics_advanced": true, "whatsapp": true, "multi_user": true, "api_access": true, "priority_support": true, "multi_tenant": true, "white_label": true, "dedicated_support": true, "custom_integration": true, "sla": true, "custom_pricing": true}', 4)
