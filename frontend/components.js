...
const paths = {
  ...
  runtime:'<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>',
  prompts:'<path d="M4 4h16v12H8l-4 4z"/><path d="M8 9h8M8 12h5"/>',
  ...
  "web-intelligence":'<circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 0 20 15.3 15.3 0 0 1 0-20z"/>',
  "wi-scraper":'<path d="M4 4h16v5H4z"/><path d="M8 13h8M8 17h5"/><path d="M4 9v11h16V9"/>',
  "wi-crawl":'<circle cx="12" cy="12" r="2.5"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4M4.9 4.9l2.8 2.8M16.3 16.3l2.8 2.8M19.1 4.9l-2.8 2.8M7.7 16.3l-2.8 2.8"/>',
  "wi-extract":'<path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M5 3h9l5 5v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M8 13h6M8 17h4"/>',
  "wi-knowledge":'<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V3H6.5A2.5 2.5 0 0 0 4 5.5z"/><path d="M9 8h6M9 11h4"/>',
  "wi-verify":'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/>',
  "wi-screenshot":'<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="12" cy="12" r="3.5"/><path d="M8 5l1.5-2h5L16 5"/>',
  "wi-settings":'<circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.9 4.9 7 7M17 17l2.1 2.1M19.1 4.9 17 7M7 17l-2.1 2.1"/>',
};
...
function getNavGroups() {
  ...
  return [
    ...
    ["web-intelligence", g("web-intelligence"), "web-intelligence", [
      ["web-intelligence", n("web-intelligence")],
      ["wi-scraper", n("wi-scraper")],
      ["wi-crawl", n("wi-crawl")],
      ["wi-extract", n("wi-extract")],
      ["wi-knowledge", n("wi-knowledge")],
      ["wi-verify", n("wi-verify")],
      ["wi-screenshot", n("wi-screenshot")],
      ["wi-settings", n("wi-settings")],
    ]],
...
function getRouteMeta() {
  ...
  return {
    ...
    "web-intelligence": r("web-intelligence"),
    "wi-scraper": r("wi-scraper"),
    "wi-crawl": r("wi-crawl"),
    "wi-extract": r("wi-extract"),
    "wi-knowledge": r("wi-knowledge"),
    "wi-verify": r("wi-verify"),
    "wi-screenshot": r("wi-screenshot"),
    "wi-settings": r("wi-settings"),
    about: r("about"),
