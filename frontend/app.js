...
async function renderAnalytics(days = state.analyticsDays) {
  ...
  <div class="grid grid-2">
    ...
    <div class="card"><div class="card-head"><h3>Service quality</h3><span class="subtle">Current ${state.analyticsDays}-day window</span></div><div class="card-body analytics-quality-rows">
      <div class="usage-row"><div class="usage-row-head"><span>AI resolution</span><b>${resolution}%</b></div><div class="progress"><span style="width:${resolution}%"></span></div></div>
      <div class="usage-row"><div class="usage-row-head"><span>Customer rating</span><b>${summary.avg_rating ? Number(summary.avg_rating).toFixed(1) : 0}/5</b></div><div class="progress"><span style="width:${Math.min(100,Number(summary.avg_rating||0)*20)}%"></span></div></div>
      <div class="usage-row"><div class="usage-row-head"><span>Automated coverage</span><b>${coveragePct}%</b></div><div class="progress"><span style="width:${coveragePct}%"></span></div></div>
    </div></div>
  </div>
...
async function renderKnowledgeBuilder() {
  ...
  <div class="card"><div class="card-head"><div><h3>Missing topics</h3><span class="subtle">Topik penting yang belum tersedia di knowledge base</span></div></div><div class="card-body" style="padding:16px">${missingTopics}</div></div>`);
}
